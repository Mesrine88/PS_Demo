...
$VHDPath = "D:\VM\DC01WW\Virtual Harddisk\DC01WWHDD000"
$VHDXSize = 60GB
$NetworkSwitch1 = "Extern"
$NetworkSwitch2 = "Privat"
$VHD2Path = "D:\VM\DC01WW\Virtual Harddisk\DC01WWHDD001"
$IsoPath = "D:\Daten\Isos\Server 2022\WIN_SERVER_2022_EVAL_x64FRE_de-de.iso"

# VM erstellen
New-VM -Name $VMName -ComputerName $ComputerName -MemoryStartupBytes $RAM -MaxMemoryStartupBytes $MaxRAM -Path $StoragePath -NewVHDPath $VHDPath -NewVHDSizeBytes $VHDXSize
