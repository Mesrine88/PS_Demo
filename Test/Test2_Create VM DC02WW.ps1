...
New-VHD -Path $VHD2Path -SizeBytes $VHDX2Size -Dynamic | Mount-VHD -Passthru

#Add-VMHardDiskDrive -VMName $VMName -DiskNumber 3
#New-VHD -Path $VHD3Path -SizeBytes $VHDX2Size -Dynamic | Mount-VHD -Path $VHD3Path

Add-VMHardDiskDrive -VMName $VMName -New-VHD -Path $VHD4Path -SizeBytes $VHDX2Size -Dynamic
